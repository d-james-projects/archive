...
def parse_args():
  parser = argparse.ArgumentParser(
      description="""
      Run a sanity test on a kubernetes cluster. Assumes a
  ...
  parser.add_argument(
      '--deployment-yaml', type=str, default='cluster/kube-deployment.yaml',
      help='yaml for the kube deployment')
  parser.add_argument(
      '--service-yaml', type=str, default='cluster/kube-test1.yaml',
      help='yaml for the test service')
  parser.add_argument(
      '--client-yaml', type=str, default='cluster/kube-test1a.yaml',
      help='yaml for the pod client')
  parser.add_argument(
